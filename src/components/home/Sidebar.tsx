    ...
    <div className="w-full lg:w-[380px] space-y-8 shrink-0">
      ...
      <div className="bg-white border border-gray-100 rounded-[32px] p-8 shadow-sm relative overflow-hidden group">
        ...
        <div className="mb-8">
           ...
           <h3 className="text-xs font-black text-gray-400 uppercase tracking-[0.2em] mt-6">Nepal Tools</h3>
        </div>
        ...
        <div className="space-y-6">
          {[
            ...
            { name: 'Provident Fund (PF)', slug: 'provident-fund', icon: Landmark }
          ].map(tool => (
            <Link 
              key={tool.slug} 
      ...
      <div className="bg-white border border-gray-100 rounded-[32px] p-8 shadow-sm">
        <h3 className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-8">Popular Right Now</h3>
        <div className="space-y-6">
          {popular.map(tool => (
            <Link 
              key={tool.id} 
      ...
      <div className="bg-white border border-gray-100 rounded-[32px] p-8 shadow-sm">
        <h3 className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-8">Quick Conversion</h3>
        ...
        <Link href="/calculator/unit-converter" className="mt-8 block text-[10px] font-black text-[#1A73E8] uppercase tracking-widest text-center hover:underline">View all converters →</Link>
      </div>
