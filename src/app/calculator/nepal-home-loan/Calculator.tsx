            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-6 space-y-6">
              <div>
                ...
                <div className="relative">
                  <input type="number" inputMode="numeric" value={amount} onChange={e => setAmount(+e.target.value)} className="w-full h-12 pl-4 pr-12 rounded-xl border-2 border-gray-100 focus:border-blue-500 outline-none font-mono text-lg font-bold" />
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input type="number" inputMode="numeric" value={tenure} onChange={e => setTenure(+e.target.value)} className="w-full h-12 px-4 rounded-xl border-2 border-gray-100 focus:border-blue-500 outline-none font-mono text-lg font-bold" />
                </div>
              </div>
            </div>
          </div>
