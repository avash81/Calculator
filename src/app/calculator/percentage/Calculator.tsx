        ...
        <div className="space-y-8">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-6">
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <input type="number" inputMode="numeric" value={val1} onChange={e => setVal1(+e.target.value)} className="w-24 h-12 px-4 rounded-xl border-2 border-gray-100 focus:border-blue-500 outline-none font-mono text-lg font-bold" />
              <span className="text-gray-500 font-medium">% of</span>
              <input type="number" inputMode="numeric" value={val2} onChange={e => setVal2(+e.target.value)} className="w-32 h-12 px-4 rounded-xl border-2 border-gray-100 focus:border-blue-500 outline-none font-mono text-lg font-bold" />
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-6">
            ...
            <div className="flex flex-wrap items-center gap-4">
              <input type="number" inputMode="numeric" value={val3} onChange={e => setVal3(+e.target.value)} className="w-32 h-12 px-4 rounded-xl border-2 border-gray-100 focus:border-blue-500 outline-none font-mono text-lg font-bold" />
              <span className="text-gray-500 font-medium">is what % of</span>
              <input type="number" inputMode="numeric" value={val4} onChange={e => setVal4(+e.target.value)} className="w-32 h-12 px-4 rounded-xl border-2 border-gray-100 focus:border-blue-500 outline-none font-mono text-lg font-bold" />
              <span className="text-gray-500 font-medium">?</span>
